...
import 'package:ditonton_siapa/common/failure.dart' as i7;
import 'package:ditonton_siapa/domain/entities/movie.dart' as i8;
import 'package:ditonton_siapa/domain/entities/tv/tv.dart' as i10;
import 'package:ditonton_siapa/domain/repositories/movie_respository.dart'
    as i2;
import 'package:ditonton_siapa/domain/repositories/tv_repository.dart' as i4;
import 'package:dartz/dartz.dart' as i3;
import 'package:mockito/mockito.dart' as i1;
import 'package:ditonton_siapa/domain/usecase/search_movies.dart' as i5;
import 'package:ditonton_siapa/domain/usecase/tv/search_tv.dart' as i9;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSearchTv extends i1.Mock implements i9.SearchTv {
  MockSearchTv() {
    i1.throwOnMissingStub(this);
  }
  ...
  @override
  i6.Future<i3.Either<i7.Failure, List<i10.Tv>>> execute(String? query) =>
      (super.noSuchMethod(Invocation.method(#execute, [query]),
              returnValue: Future<i3.Either<i7.Failure, List<i10.Tv>>>.value(
                  _FakeEither_1<i7.Failure, List<i10.Tv>>()))
          as i6.Future<i3.Either<i7.Failure, List<i10.Tv>>>);
}
